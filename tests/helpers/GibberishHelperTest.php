...
namespace delaneymethod\spamshield\tests\helpers;
...
class GibberishHelperTest extends TestCase
{
    ...
    public function testFixtures(): void
    {
        foreach ($this->getTestFixtures() as $fixture) {
            ...
            $message = 'Payload: ' . json_encode($fixture['payload'], \JSON_PRETTY_PRINT | \JSON_UNESCAPED_SLASHES | \JSON_UNESCAPED_UNICODE) . ' | Report: ' . json_encode($reports, \JSON_PRETTY_PRINT | \JSON_UNESCAPED_SLASHES | \JSON_UNESCAPED_UNICODE);
